...
uses
  ...
  FMX.Objects, FMX.Controls.Presentation, FMX.Layouts, Tactic, System.IOUtils,
  System.ImageList, FMX.ImgList, System.Actions, FMX.ActnList, FMX.StdActns,
...
procedure TForm6.Circle10Click(Sender: TObject);
begin
  ActiveIndex := 9;
  Form9.Show;
end;

procedure TForm6.Circle11Click(Sender: TObject);
begin
  ActiveIndex := 10;
  Form9.Show;
end;
...
procedure TForm6.Circle2Click(Sender: TObject);
begin
  ActiveIndex := 1;
  Form9.Show;
end;

procedure TForm6.Circle3Click(Sender: TObject);
begin
  ActiveIndex := 2;
  Form9.Show;
end;

procedure TForm6.Circle4Click(Sender: TObject);
begin
  ActiveIndex := 3;
  Form9.Show;
end;

procedure TForm6.Circle5Click(Sender: TObject);
begin
  ActiveIndex := 4;
  Form9.Show;
end;

procedure TForm6.Circle6Click(Sender: TObject);
begin
  ActiveIndex := 5;
  Form9.Show;
end;

procedure TForm6.Circle7Click(Sender: TObject);
begin
  ActiveIndex := 6;
  Form9.Show;
end;

procedure TForm6.Circle8Click(Sender: TObject);
begin
  ActiveIndex := 7;
  Form9.Show;
end;

procedure TForm6.Circle9Click(Sender: TObject);
begin
  ActiveIndex := 8;
  Form9.Show;
end;
...
function TForm6.InfoBitmap: TIntegerArray;
var
  ImgX, ImgY: Integer;
  lbit, hbit: Integer;
begin
...
procedure TForm6.PlacePlayer(lbit: Integer; hbit: Integer; ImgX: Integer;
  ImgY: Integer);
var
  I: Integer;
  LBmp: TBitmap;
...
procedure TForm6.Image1Resize(Sender: TObject);
var
  t: TIntegerArray;
  ImgX, ImgY: Integer;
  lbit, hbit: Integer;
...
procedure TForm6.ShowShareSheetAction1BeforeExecute(Sender: TObject);
var
  Bmp: TBitmap;
begin
  Bmp := TBitmap.Create;
