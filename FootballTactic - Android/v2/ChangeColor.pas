...
begin
  for I := 0 to 10 do
    MainFormv2.TabCircle[I].Fill.Color := ColorPanel1.Color;

  ColorButton1.Color := ColorPanel1.Color;
  if Assigned(MainFormv2.ActiveTactic) then
    MainFormv2.ActiveTactic.Color[0] := ColorToString(ColorPanel1.Color);
...
begin
  for I := 0 to 10 do
    MainFormv2.TabCircle[I].Stroke.Color := ColorPanel2.Color;

  ColorButton2.Color := ColorPanel2.Color;
  if Assigned(MainFormv2.ActiveTactic) then
    MainFormv2.ActiveTactic.Color[1] := ColorToString(ColorPanel2.Color);
...
begin
  for I := 0 to 10 do
    MainFormv2.TabText[I].Color := ColorPanel3.Color;

  ColorButton3.Color := ColorPanel3.Color;
  if Assigned(MainFormv2.ActiveTactic) then
    MainFormv2.ActiveTactic.Color[2] := ColorToString(ColorPanel3.Color);
...
begin
  ...
  ColorPanel2.Visible := false;
  ColorPanel3.Visible := false;
  ColorButton1.Color := MainFormv2.Circle1.Fill.Color;
  ColorButton2.Color := MainFormv2.Circle1.Stroke.Color;
  ColorButton3.Color := MainFormv2.Text1.Color;
