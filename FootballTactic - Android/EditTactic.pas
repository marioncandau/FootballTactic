...
begin
  ...
  Form6.ActiveTactic.Edit([nbDef, nbMilDef, nbMil, nbMilOff, nbAtt]);
...
begin
  EditNbDef.Text := IntToStr(Form6.ActiveTactic.Postes[0]);
  EditNbMDef.Text := IntToStr(Form6.ActiveTactic.Postes[1]);
  EditNbMil.Text := IntToStr(Form6.ActiveTactic.Postes[2]);
  EditNbMOff.Text := IntToStr(Form6.ActiveTactic.Postes[3]);
  EditNbAtt.Text := IntToStr(Form6.ActiveTactic.Postes[4]);
end;
